...
def get_random_sample(dataset):
    ...
    image_file = dataset.images_lst.filename[rnd_idx ]
    rnd_target = dataset.images_lst.label[rnd_idx ]
    rnd_image = np.load(os.path.join(dataset.yupu_path, os.path.basename(image_file) + '.npy'))
